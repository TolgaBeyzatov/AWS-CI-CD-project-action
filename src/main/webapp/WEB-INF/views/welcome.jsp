...
Terraform, GitHub, GitHub Actions, SonarQube Cloud, Docker, Maven, AWS services such as ECS, ECR, EC2, S3, API Gateway, Parameter Store, IAM, VPC, ALB, VPC Link, RDS MySQL, Elasticache Memcached, RabbitMQ.</p>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <span>
                        <h1 class="panel-title pull-left" style="font-size:30px;">${pageContext.request.userPrincipal.name} &nbsp; <small>${pageContext.request.userPrincipal.name}@devops.co.bg</small> <i class="fa fa-check text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title=" sharing with you"></i></h1>
